...
const Navbar2 = () => {
    ...
    return (
        <nav className="sticky top-0 z-50 bg-black/75 backdrop-blur-lg border-b">
            <div className="max-w-8xl mx-auto px-4 sm:px-4 lg:px-4 flex items-center justify-between h-13">
            ...
            <div className="relative flex items-center gap-3" ref={dropdownRef}>
                ...
                {isDropdownOpen && (
                <ul className="absolute top-10 right-0 mt-2 w-48 bg-card border border-white/10 rounded-lg shadow-2xl py-1 transition-all duration-300 animate-in fade-in-0 zoom-in-95">
